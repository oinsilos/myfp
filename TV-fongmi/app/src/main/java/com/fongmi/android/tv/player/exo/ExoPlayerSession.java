...
final class ExoPlayerSession {
    ...
    ExoPlayerSession(int decode, Player.Listener listener, AudioProcessor audioProcessor) {
        ...
        DefaultPreloadManager.Builder builder = createPreloadManagerBuilder(audioProcessor);
