...
export function trace(desc, message, level = "info") {
    if (__DEV__) {
...
export function errorLog(desc, message) {
...
export function devLog(method, ...args) {
