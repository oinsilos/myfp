import { IPluginHost, IPluginSandbox } from "./types";
 ...
 */
export class EvalSandbox implements IPluginSandbox {
...
export const evalSandbox: IPluginSandbox = new EvalSandbox();