...
export default function AboutSetting() {
    ...
    return (<View style={[
            ...
            checkAndShowResult(true);
                    ...
                    <Image source={ImgAsset.author} style={style.image} resizeMode="contain"/>
                </TouchableOpacity>
            ...
            <ScrollView contentContainerStyle={style.scrollViewContainer} style={style.scrollView}>
                ...
                <Image source={ImgAsset.wechatChannel} style={style.wcChannel}/>
