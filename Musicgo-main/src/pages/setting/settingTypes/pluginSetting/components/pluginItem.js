...
import pluginManager, { usePluginEnabled } from "@/core/pluginManager";
...
function _PluginItem(props) {
        ...
        },
        {
            ...
            onPress() {
                showDialog("RadioDialog", {
                    ...
                    defaultSelected: pluginManager.getAlternativePluginName(plugin),
                    onOk(value) {
                        if (value === plugin.name) {
                            pluginManager.setAlternativePluginName(plugin, null);
                        }
                        else {
                            pluginManager.setAlternativePluginName(plugin, value);
                        }
                        rerender();
                    },
    ...
    return (<View style={[
            ...
            <View style={styles.header}>
                ...
                <ThemeSwitch value={enabled} onValueChange={val => {
            ...
            version: plugin.instance.version,
                ...
                {plugin.instance.author ? (<ThemeText fontSize="subTitle" fontColor="textSecondary" numberOfLines={1} style={styles.author}>
            ...
            <View style={styles.contents}>
                {options.map((it, index) => it.show !== false ? (<IconTextButton key={index} icon={it.icon} onPress={it.onPress}>
                            {it.title}
                        </IconTextButton>) : null)}
            </View>
        </View>
