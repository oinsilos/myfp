...
export default function PluginSort() {
    ...
    const { t } = useI18N();
    function renderSortingItem({ item }) {
        return (<View style={style.sortItem}>
    ...
    return (<>
            ...
            <HorizontalSafeAreaView style={globalStyle.flex1}>
                <SortableFlatList data={sortingPlugins} activeBackgroundColor={colors.placeholder} marginTop={marginTop} renderItem={renderSortingItem} itemHeight={ITEM_HEIGHT} itemJustifyContent={"space-between"} onSortEnd={data => {
