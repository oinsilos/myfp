...
function HomeDrawer(props) {
    ...
    function navigateToSetting(settingType) {
    ...
    return (<>
            ...
            <DrawerContentScrollView {...[props]} style={style.scrollWrapper}>
                ...
                <View style={style.card}>
                    ...
                    {basicSetting.map((item, index) => (<ListItem withHorizontalPadding key={"basic-setting-" + index} onPress={item.onPress}>
                            <ListItem.ListItemIcon icon={item.icon} width={rpx(48)}/>
                ...
                <View style={style.card}>
                    ...
                    <CountDownItem />
                    {otherSetting.map((item, index) => (<ListItem withHorizontalPadding key={"other-setting-" + index} onPress={item.onPress}>
                            <ListItem.ListItemIcon icon={item.icon} width={rpx(48)}/>
                            <ListItem.Content title={item.title}/>
                        </ListItem>))}
            ...
            showDialog("RadioDialog", {
                ...
                <View style={style.card}>
                    ...
                    <ListItem withHorizontalPadding key={"update"} onPress={() => {
            checkUpdateAndShowResult(true);
        }}>
                        <ListItem.ListItemIcon icon={"arrow-path"} width={rpx(48)}/>
                    ...
                    <ListItem withHorizontalPadding key={"about"} onPress={() => {
            navigateToSetting("about");
        }}>
                        <ListItem.ListItemIcon icon={"information-circle"} width={rpx(48)}/>
            ...
            BackHandler.exitApp();
                ...
                <ListItem withHorizontalPadding onPress={async () => {
            await TrackPlayer.reset();
            NativeUtils.exitApp();
        }}>
                    <ListItem.ListItemIcon icon={"power-outline"} width={rpx(48)}/>
...
function _CountDownItem() {
    ...
    const { t } = useI18N();
    return (<ListItem withHorizontalPadding onPress={() => {
