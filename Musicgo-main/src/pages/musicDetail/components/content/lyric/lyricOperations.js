...
export default function LyricOperations(props) {
    ...
    return (<View style={styles.container}>
            ...
            <Icon name="font-size" size={iconSizeConst.normal} color="white" onPress={() => {
            ...
            <Icon name="arrows-left-right" size={iconSizeConst.normal} color="white" onPress={() => {
            ...
            <Icon name="magnifying-glass" size={iconSizeConst.normal} color="white" onPress={() => {
            ...
            <TranslationIcon width={iconSizeConst.normal} height={iconSizeConst.normal} opacity={!hasTranslation ? 0.2 : showTranslation ? 1 : 0.5} color={showTranslation && hasTranslation ? colors.primary : "white"} 
    // style={}
    onPress={() => {
            if (!hasTranslation) {
                Toast.warn("当前歌曲无翻译");
            ...
            PersistStatus.set("lyric.showTranslation", !showTranslation);
            scrollToCurrentLrcItem();
        }}/>
            <Icon name="ellipsis-vertical" size={iconSizeConst.normal} color={"white"} onPress={() => {
            const currentMusic = TrackPlayer.currentMusic;
            if (currentMusic) {
