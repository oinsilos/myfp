...
export default function SubscribePluginDialog(props) {
            ...
            <Dialog.Content style={[style.dialogContent, containerStyles]}>
                <View style={style.inputSection}>
                    ...
                    <View style={[style.inputContainer, { borderColor: colors.divider, backgroundColor: colors.card }]}>
                        <Input hasHorizontalPadding={false} style={[style.textInput, inputStyles]} value={name} onChangeText={text => {
            setName(text);
        }} placeholder={t("common.name")} placeholderTextColor={colors.textSecondary}/>
                    </View>
                </View>
                ...
                <View style={style.inputSection}>
                    ...
                    <View style={[style.inputContainer, { borderColor: colors.divider, backgroundColor: colors.card }]}>
                        <Input hasHorizontalPadding={false} style={[style.textInput, inputStyles]} value={url} onChangeText={text => {
            setUrl(text);
        }}/>
                    </View>
                </View>
