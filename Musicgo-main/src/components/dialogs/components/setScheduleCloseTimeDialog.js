...
export default function SetScheduleCloseTimeDialog(props) {
    const { onOk } = props;
    ...
    return (<Dialog onDismiss={hideDialog}>
                ...
                <View style={style.inputSection}>
                    <View style={style.inputRow}>
                        <View style={[style.inputContainer, { borderColor: colors.divider, backgroundColor: colors.card }]}>
                            <Input hasHorizontalPadding={false} style={[style.textInput, inputStyles]} value={timeInput} onChangeText={text => {
            // Only allow numbers
        ...
        }} placeholder={placeholder || t("dialog.setScheduleCloseTime.placeholder")} placeholderTextColor={colors.textSecondary} keyboardType="numeric" maxLength={4}/>
                        </View>
