...
export default function ImageViewer(props) {
    ...
    const { t } = useI18N();
    return (<PanelFullscreen hasMask animationType="Scale" containerStyle={styles.container}>
            <Image style={orientation === "vertical"
            ? {
                width: vw(100),
                minHeight: vw(100),
                maxHeight: vh(100),
            ...
            <Button text={t("panel.imageViewer.saveImage")} type="primary" style={styles.button} onPress={() => {
            saveToGallery(url)
                .then((resultPath) => {
